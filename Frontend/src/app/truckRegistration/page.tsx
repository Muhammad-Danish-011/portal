...
import { truckFormSchema } from '@/components/functional/FormValidations/truckValidation';
...
const FormForTruck = () => {
    ...
    const [formData, setFormData] = useState<truckRegistration>({
        imageBase64: '',
        listingTitle: '',
        make: '',
        model: '',
    ...
    const handleSubmit = async (formData: truckRegistration) => {
        ...
        try {
            ...
            const response = await fetch("https://backend-portal-hinb.onrender.com/api/truck", {
                method: "POST",
                headers: {

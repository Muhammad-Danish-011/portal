        ...
        <footer className="bg-gray-900 text-white pt-6 pb-4 ">
            <div className="container mx-auto px-4 mr-6">
                {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8"> */}
                    ...
                    {/* <div>
                        <h5 className="text-lg font-semibold mb-3">Headquarters</h5>
                        <div className="flex items-start gap-3 mb-3">
                            <Image src="/uae_flag.jpg" alt="AE" width={24} height={24} />
                            <p className="text-sm">
                        ...
                        <div className="flex items-start gap-3 mb-3">
                            <Image src="/JP.svg" alt="JP" width={24} height={24} />
                            <p className="text-sm">
                                7103 Kaburagi Mansion, Nishi Nakanobu, 3-2-17, Shinagawa Ku, 142-0054 <br />
                                <b>Tokyo, Japan</b>
                            </p>
                        </div>
                    </div>
                    ...
                    {/* <div>
                        ...
                        <div className="flex items-start gap-3 mb-3">
                            ...
                            <ul className="text-sm space-y-1">
                                <li><a href="tel:+49 471 9731 9003">+49 471 9731 9003</a></li>
                                <li><a href="tel:+971 52 796 7035">+971 52 796 7035</a></li>
                                <li><a href="tel:+81 50 5050 8550">+81 50 5050 8550</a></li>
                            </ul>
                        </div>
                        <div className="text-sm">
                            <h6 className="font-medium">Corporate Site:</h6>
                            <a href="https://www.universalmotorsltd.com/" className="text-cyan-400 underline">
                                www.universalmotorsltd.com
                            </a>
                            <h6 className="mt-2 font-medium">Email:</h6>
                            <a href="mailto:csd@universalmotorsltd.com" className="text-cyan-400 underline">
                ...
                <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
                    ...
                    <div className="text-center mb-3 md:mb-0">
                        <p>&copy; {new Date().getFullYear()} Universal Motors. All rights reserved.</p>
                    </div>
